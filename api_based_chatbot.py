...
api_key = "AQ.Ab8RN6JMr9Jd0oN9Je6dUxybTW6H99vUjkb6v2czwmlrvdZLoQ"
    ...
    with col02:
        ...
        with st.form('Question2'):
            ...
            if st.form_submit_button("Hope it helped"):
                ...
                linkedin_url = "https://www.linkedin.com/in/preeti-yadav-1bb0002a3?"
    
                linkedin_link = f"[preeti yadav]({linkedin_url})"
